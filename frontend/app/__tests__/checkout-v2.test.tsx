...
describe("CheckoutV2Screen", () => {
  ...
  describe("Paso 1 — Dirección", () => {
    ...
    it("muestra error si se intenta continuar sin seleccionar dirección", async () => {
  ...
  describe("Paso 2 — Método de pago", () => {
    ...
    it("muestra error si se intenta continuar sin método de pago", async () => {
      await renderAtStep("payment");
      fireEvent.press(screen.getByText("Revisar Orden"));
      await waitFor(() => {
        expect(
  ...
  describe("Error paths", () => {
    it("muestra error cuando createOrder falla", async () => {
    ...
    it("muestra error cuando createMercadoPagoPreference falla", async () => {
