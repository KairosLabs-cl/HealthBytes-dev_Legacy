...
export const config = {
  light: vars({
    ...
    /* App Semantic */
    "--color-surface-warm": "252 250 248",
    "--color-surface-card": "255 255 255",
    "--color-surface-elevated": "250 250 249",
    "--color-surface-muted": "245 245 244",
    "--color-ink-primary": "45 41 38",
    "--color-ink-muted": "107 107 107",
    "--color-ink-subtle": "156 163 175",
    "--color-ink-inverse": "255 255 255",
    "--color-border-subtle": "232 230 227",
    "--color-border-default": "209 213 219",
    "--color-border-focus": "45 41 38",
    "--color-icon-primary": "45 41 38",
    "--color-icon-muted": "107 107 107",
    "--color-icon-accent": "46 92 58",
    "--color-accent-primary": "92 107 90",
    "--color-accent-hover": "74 86 73",
    "--color-accent-light": "240 253 244",
    "--color-state-success": "74 124 89",
    "--color-state-warning": "184 134 11",
    "--color-state-error": "155 77 77",
    "--color-state-info": "92 107 90",
    "--color-brand-green": "46 92 58",
    "--color-brand-green-light": "240 253 244",
  ...
  dark: vars({
    ...
    /* App Semantic */
    "--color-surface-warm": "28 28 30",
    "--color-surface-card": "44 44 46",
    "--color-surface-elevated": "58 58 60",
    "--color-surface-muted": "48 48 50",
    "--color-ink-primary": "245 240 235",
    "--color-ink-muted": "190 185 180",
    "--color-ink-subtle": "156 163 175",
    "--color-ink-inverse": "28 28 30",
    "--color-border-subtle": "58 58 60",
    "--color-border-default": "82 82 84",
    "--color-border-focus": "245 240 235",
    "--color-icon-primary": "245 240 235",
    "--color-icon-muted": "190 185 180",
    "--color-icon-accent": "76 175 114",
    "--color-accent-primary": "118 153 116",
    "--color-accent-hover": "140 174 138",
    "--color-accent-light": "32 62 42",
    "--color-state-success": "110 181 133",
    "--color-state-warning": "224 180 75",
    "--color-state-error": "219 128 128",
    "--color-state-info": "126 164 201",
    "--color-brand-green": "76 175 114",
    "--color-brand-green-light": "32 62 42",
