...
## 2026-05-09 - Zustand useShallow Optimization
**Learning:** Extracting multiple primitive fields from a Zustand store using separate selector calls creates multiple subscriptions, adding overhead, especially in lists and root layouts.
