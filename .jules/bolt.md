...
## 2026-04-25 - Zustand Array Element Subscriptions
...
**Action:** Use inline selectors to access specific array elements or primitive properties (e.g., `useCart((state) => state.items.find(i => i.id === id)?.quantity || 0)`).
