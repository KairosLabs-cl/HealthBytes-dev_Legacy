...
class TestListUsers:
    ...
    def test_list_users_rejects_limit_too_high(self, mock_get_user, client: TestClient, db_session: Session):
    ...
    @patch('app.middleware.auth.get_current_user')
    def test_list_users_rejects_limit_zero(self, mock_get_user, client: TestClient, db_session: Session):
    ...
    @patch('app.middleware.auth.get_current_user')
    def test_list_users_rejects_negative_skip(self, mock_get_user, client: TestClient, db_session: Session):
    ...
    @patch('app.middleware.auth.get_current_user')
    def test_list_users_rejects_limit_1000000(self, mock_get_user, client: TestClient, db_session: Session):
...
class TestGetUserById:
    ...
    def test_get_user_by_id_returns_404_for_nonexistent(self, client: TestClient, db_session: Session):
