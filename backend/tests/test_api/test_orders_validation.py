"""
Tests para validacion de precios en ordenes.
Verifica que el backend no confie en los precios enviados por el cliente.
"""
...
async def test_order_uses_database_price_not_client_price(
    ...
    """
    TEST: Cliente intenta enviar precio falso - el precio debe venir de BD.
    """
    order_data = {
        "order": {},
        "items": [
